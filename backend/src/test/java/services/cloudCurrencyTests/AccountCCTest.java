...
public class AccountCCTest {
    ...
    public void testUpdateAccount() {
        ...
        assertEquals(result.getBody().get("api_trading").asBoolean(),true);
        assertEquals(result.getBody().get("online_trading").asBoolean(),true);
        assertEquals(result.getBody().get("phone_trading").asBoolean(),true);
        assertEquals(result.getBody().get("process_third_party_funds").asBoolean(),false);
        assertEquals(result.getBody().get("settlement_type").asText(),"net");
        assertEquals(result.getBody().get("agent_or_reliance").asBoolean(),false);
