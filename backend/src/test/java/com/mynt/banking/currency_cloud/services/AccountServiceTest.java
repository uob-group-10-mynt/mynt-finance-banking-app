...
import com.mynt.banking.currency_cloud.manage.accounts.requests.CurrencyCloudUpdateAccountRequest;
...
public class AccountServiceTest {
    ...
    @Autowired
    private com.mynt.banking.currency_cloud.manage.accounts.CurrencyCloudAccountsService accountService;
    ...
    public void testUpdateAccount() {
        ...
        CurrencyCloudUpdateAccountRequest requestBody = CurrencyCloudUpdateAccountRequest.builder()
                .accountName("Kelvin")
                .legalEntityType("individual")
        ...
        ResponseEntity<JsonNode> result = accountService.updateAccount(id,requestBody);
